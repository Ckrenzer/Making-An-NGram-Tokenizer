...
Finally, let's put our functions to the test! They will be compared, at n = 2, both to each other and official tokenizers found on CRAN. This takes a while to run.


```{r benchmark}

tokenizer_speeds <- microbenchmark::microbenchmark(
